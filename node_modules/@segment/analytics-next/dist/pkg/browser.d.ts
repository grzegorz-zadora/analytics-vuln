...
export declare function loadLegacySettings(writeKey: string): Promise<LegacySettings>;
export declare class AnalyticsBrowser {
    static load(settings: AnalyticsBrowserSettings, options?: InitOptions): Promise<[Analytics, Context]>;
