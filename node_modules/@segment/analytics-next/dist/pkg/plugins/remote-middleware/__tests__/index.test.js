...
describe('Remote Middleware', function () {
    ...
    it('ignores empty dictionaries', function () { return __awaiter(void 0, void 0, void 0, function () {
        var md;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, remoteMiddlewares(Context.system(), {
                        integrations: {},
                    })];
                case 1:
                    md = _a.sent();
    ...
    it('doesnt load entries if their value is false', function () { return __awaiter(void 0, void 0, void 0, function () {
        var md;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, remoteMiddlewares(Context.system(), {
    ...
    it('loads middleware that exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var md;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, remoteMiddlewares(Context.system(), {
    ...
    it('ignores segment namespace', function () { return __awaiter(void 0, void 0, void 0, function () {
        var md;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, remoteMiddlewares(Context.system(), {
    ...
    it('loads middleware through remote script tags', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sources;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, remoteMiddlewares(Context.system(), {
    ...
    it('ignores middleware that do not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var ctx, md;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ctx = Context.system();
                    return [4 /*yield*/, remoteMiddlewares(ctx, {
                            integrations: {},
                            enabledMiddleware: {
                                '@segment/analytics.js-middleware-braze-deduplicate': true,
