...
var trackPurchase = __assign(__assign({}, trackEvent), { name: 'Braze Web Mode (Actions) trackPurchase' });
var updateUserProfile = __assign(__assign({}, trackEvent), { name: 'Braze Web Mode (Actions) updateUserProfile' });
var amplitude = __assign(__assign({}, trackEvent), { name: 'amplitude' });
var fullstory = __assign(__assign({}, trackEvent), { name: 'Fullstory (Actions) trackEvent' });
describe('schema filter', function () {
    ...
    describe('plugins and destinations', function () {
        it('loads plugin', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('does not drop events when no plan is defined', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ajs.register(segment, trackEvent, trackPurchase, updateUserProfile, schemaFilter({}, settings))];
                    case 1:
                        _a.sent();
        ...
        it('drops an event when the event is disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ajs.register(segment, trackEvent, trackPurchase, updateUserProfile, amplitude, schemaFilter({
                            hi: {
                                enabled: true,
                                integrations: {
        ...
        it('does not drop events with same name when unplanned events are disallowed', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ajs.register(segment, trackEvent, trackPurchase, updateUserProfile, amplitude, schemaFilter({
        ...
        it('drop events with different names when unplanned events are disallowed', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ajs.register(segment, trackEvent, trackPurchase, updateUserProfile, amplitude, schemaFilter({
                            __default: { enabled: false, integrations: {} },
        ...
        it('does not drop event for non-matching destination', function () { return __awaiter(void 0, void 0, void 0, function () {
            var filterXt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filterXt = schemaFilter({
                            'Track Event': {
                                enabled: true,
    ...
    describe('action destinations', function () {
        it('disables action destinations', function () { return __awaiter(void 0, void 0, void 0, function () {
            var filterXt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('covers different names between remote plugins and integrations', function () { return __awaiter(void 0, void 0, void 0, function () {
            var filterXt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
