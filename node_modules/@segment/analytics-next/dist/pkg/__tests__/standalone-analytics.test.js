...
describe('standalone bundle', function () {
    ...
    it('derives the CDN from scripts on the page', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    // @ts-ignore ignore Response required fields
                    mocked(unfetch).mockImplementation(function () { return fetchSettings; });
                    return [4 /*yield*/, loadLegacySettings(segmentDotCom)];
                case 1:
                    _a.sent();
                    expect(unfetch).toHaveBeenCalledWith('https://cdn.foo.com/v1/projects/foo/settings');
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('sets buffered event emitters before loading destinations', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var operations;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
