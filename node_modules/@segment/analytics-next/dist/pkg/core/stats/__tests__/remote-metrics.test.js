...
describe('remote metrics', function () {
    ...
    test('sends requests on flush', function () { return __awaiter(void 0, void 0, void 0, function () {
        var spy, remote;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spy = mocked(unfetch).mockImplementation();
                    remote = new RemoteMetrics({
                        sampleRate: 100,
                    });
                    remote.increment('analytics_js.banana', ['phone:1']);
    ...
    test('clears queue after sending', function () { return __awaiter(void 0, void 0, void 0, function () {
        var remote;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test('does not crash on errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mocked(unfetch).mockImplementation(function () {
                        throw error;
                    });
                    remote = new RemoteMetrics({
                        sampleRate: 100,
    ...
    test('disables metrics reporting in case of errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        var error, remote;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
