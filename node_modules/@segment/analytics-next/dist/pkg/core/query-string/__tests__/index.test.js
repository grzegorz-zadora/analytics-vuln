...
describe('queryString', function () {
    ...
    describe('calls', function () {
        describe('identify', function () {
            ...
            it('accepts encoded emails as `ajs_uid` params', function () { return __awaiter(void 0, void 0, void 0, function () {
                var spy;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            spy = jest.spyOn(analytics, 'identify');
                            return [4 /*yield*/, queryString(analytics, '?ajs_uid=user%40example.org')];
                        case 1:
                            _a.sent();
