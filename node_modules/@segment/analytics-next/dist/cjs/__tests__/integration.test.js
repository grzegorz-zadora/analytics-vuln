...
jest.mock('unfetch', function () {
    ...
    return tslib_1.__assign(tslib_1.__assign({ __esModule: true }, originalModule), { default: function () {
            var args = [];
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, browser_1.AnalyticsBrowser.load({ writeKey: writeKey, plugins: [lazyPlugin] })];
                case 1:
                    _a.sent();
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, browser_1.AnalyticsBrowser.load({
                            writeKey: writeKey,
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, browser_1.AnalyticsBrowser.load({ writeKey: writeKey }, { initialPageview: true })];
                case 1:
                    _a.sent();
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mockPage = jest.fn();
                    analytics_1.Analytics.prototype.page = mockPage;
                    return [4 /*yield*/, browser_1.AnalyticsBrowser.load({ writeKey: writeKey }, { initialPageview: false })];
                case 1:
                    _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, browser_1.AnalyticsBrowser.load(settings, options)];
                    case 1:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, browser_1.AnalyticsBrowser.load(tslib_1.__assign(tslib_1.__assign({}, settings), { plugins: [xt] }), options)];
                    case 1:
                        analyticsResponse = _a.sent();
...
describe('retries', function () {
    ...
    beforeEach(function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            ...
            browser_1.loadLegacySettings = jest.fn().mockReturnValue(Promise.resolve({
    ...
    it('does not retry errored events if retryQueue setting is set to false', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, browser_1.AnalyticsBrowser.load({ writeKey: test_writekeys_1.TEST_WRITEKEY }, { retryQueue: false })];
                case 1:
                    ajs = (_a.sent())[0];
                    expect(ajs.queue.queue).toStrictEqual(new persisted_1.PersistedPriorityQueue(1, 'event-queue'));
    ...
    it('does not queue up events when offline if retryQueue setting is set to false', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var ajs;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, browser_1.AnalyticsBrowser.load({ writeKey: writeKey })];
                case 1:
                    ajs = (_a.sent())[0];
                    return [4 /*yield*/, ajs.queue.register(context_1.Context.system(), tslib_1.__assign(tslib_1.__assign({}, testPlugin), { ready: function () { return Promise.resolve(true); }, track: function (ctx) { return ctx; } }), ajs)
                        // @ts-ignore ignore reassining function
                    ];
                case 2:
                    _a.sent();
...
describe('.Integrations', function () {
    ...
    it('lists all legacy destinations', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ga = new ajs_destination_1.LegacyDestination('Google-Analytics', 'latest', {}, {});
                    return [4 /*yield*/, browser_1.AnalyticsBrowser.load({
                            writeKey: writeKey,
    ...
    it('catches destinations with dots in their names', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ga = new ajs_destination_1.LegacyDestination('Google-Analytics', 'latest', {}, {});
                    customerIO = new ajs_destination_1.LegacyDestination('Customer.io', 'latest', {}, {});
                    return [4 /*yield*/, browser_1.AnalyticsBrowser.load({
                            writeKey: writeKey,
