...
describe('standalone bundle', function () {
    ...
    it('derives the CDN from scripts on the page', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    // @ts-ignore ignore Response required fields
                    utils_1.mocked(unfetch_1.default).mockImplementation(function () { return fetchSettings; });
                    return [4 /*yield*/, browser_1.loadLegacySettings(segmentDotCom)];
                case 1:
                    _a.sent();
                    expect(unfetch_1.default).toHaveBeenCalledWith('https://cdn.foo.com/v1/projects/foo/settings');
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('sets buffered event emitters before loading destinations', function (done) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var operations;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    operations = [];
                    track.mockImplementationOnce(function () { return operations.push('track'); });
                    on.mockImplementationOnce(function () { return operations.push('on', 'on'); });
                    register.mockImplementationOnce(function () { return operations.push('register'); });
                    return [4 /*yield*/, standalone_analytics_1.install()];
                case 1:
                    _a.sent();
