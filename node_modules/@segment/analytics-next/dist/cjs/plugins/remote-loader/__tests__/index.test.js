...
var loader = tslib_1.__importStar(require("../../../lib/load-script"));
var __1 = require("..");
...
describe('Remote Loader', function () {
    ...
    it('should attempt to load a script from the url of each remotePlugin', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.remoteLoader({
                        integrations: {},
                        remotePlugins: [
                            {
                                name: 'remote plugin',
    ...
    it('should attempt to load a script from a custom CDN', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    window.analytics = {};
                    window.analytics._cdn = 'foo.com';
                    return [4 /*yield*/, __1.remoteLoader({
                            integrations: {},
                            remotePlugins: [
                                {
                                    name: 'remote plugin',
    ...
    it('should attempt calling the library', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.remoteLoader({
                        integrations: {},
    ...
    it('should not load remote plugins when integrations object contains all: false', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.remoteLoader({
                        integrations: {},
    ...
    it('should load remote plugins when integrations object contains all: false but plugin: true', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.remoteLoader({
                        integrations: {},
    ...
    it('should load remote plugin when integrations object contains plugin: false', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.remoteLoader({
                        integrations: {},
    ...
    it('should skip remote plugins that arent callable functions', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var plugins;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.remoteLoader({
    ...
    it('should return all plugins resolved remotely', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    it('should ignore plugins that fail to initialize', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var plugins;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    jest.spyOn(loader, 'loadScript').mockImplementation(function (url) {
                        ...
                        window['asyncFlaky'] = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                                throw Error('aaay');
                            });
                        }); };
    ...
    it('ignores invalid plugins', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
