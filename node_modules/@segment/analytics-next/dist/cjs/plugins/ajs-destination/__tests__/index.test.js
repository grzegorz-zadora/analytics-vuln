...
var test_writekeys_1 = require("../../../__tests__/test-writekeys");
var cdnResponse = {
    integrations: {
        Zapier: {
            type: 'server',
...
describe('loading ajsDestinations', function () {
    ...
    it('loads version overrides', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var destinations, withVersionSettings, withVersionOverrides, withNoVersion;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.ajsDestinations(cdnResponse, {}, {})];
                case 1:
    ...
    it('ignores Iterable', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    describe('versionSettings.components', function () {
        it('ignores [componentType:browser] when bundlingStatus is unbundled', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var destinations;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __1.ajsDestinations({
                            integrations: {
        ...
        it('loads [componentType:browser] when bundlingStatus is not defined', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var destinations;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __1.ajsDestinations({
    ...
    it('loads type:browser legacy ajs destinations from cdn', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var destinations;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.ajsDestinations(cdnResponse, {}, {})
    ...
    it('ignores type:browser when bundlingStatus is unbundled', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var destinations;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.ajsDestinations({
    ...
    it('loads type:browser when bundlingStatus is not defined', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var destinations;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.ajsDestinations({
    ...
    it('ignores destinations of type:server', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var destinations;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.ajsDestinations(cdnResponse, {}, {})];
    ...
    it('does not load integrations when All:false', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var destinations;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.ajsDestinations(cdnResponse, {
    ...
    it('loads integrations when All:false, <integration>: true', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var destinations;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __1.ajsDestinations(cdnResponse, {
    ...
    it('adds a tsub middleware for matching rules', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
...
describe('settings', function () {
    it('does not delete type=any', function () {
        var dest = new __1.LegacyDestination('Yandex', 'latest', {
            type: 'custom',
        }, {});
        expect(dest.settings['type']).toEqual('custom');
    });
    it('deletes type=browser', function () {
        var dest = new __1.LegacyDestination('Amplitude', 'latest', {
            type: 'browser',
        }, {});
...
describe('remote loading', function () {
    var loadAmplitude = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var ajs, dest;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    dest = new __1.LegacyDestination('Amplitude', 'latest', {
                        apiKey: test_writekeys_1.AMPLITUDE_WRITEKEY,
                    }, {});
                    return [4 /*yield*/, dest.load(context_1.Context.system(), ajs)];
                case 1:
                    _a.sent();
    ...
    it('loads integrations from the Segment CDN', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var sources;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('forwards identify calls to integration', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dest, evt;
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    evt = new context_1.Context({ type: 'identify' });
    ...
    it('forwards track calls to integration', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dest;
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, dest.track(new context_1.Context({ type: 'track' }))];
                case 2:
                    _b.sent();
    ...
    it('forwards page calls to integration', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dest;
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, dest.page(new context_1.Context({ type: 'page' }))];
                case 2:
                    _b.sent();
    ...
    it('applies remote routing rules', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dest;
        var _a, _b, _c;
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    dest = _d.sent();
                    jest.spyOn(dest.integration, 'track');
                    dest.addMiddleware(routing_middleware_1.tsubMiddleware((_b = (_a = cdnResponse.middlewareSettings) === null || _a === void 0 ? void 0 : _a.routingRules) !== null && _b !== void 0 ? _b : []));
                    // this routing rule should drop the event
                    return [4 /*yield*/, dest.track(new context_1.Context({ type: 'track', event: 'Item Impression' }))];
                case 2:
                    // this routing rule should drop the event
                    _d.sent();
...
describe('plan', function () {
    ...
    var loadAmplitude = function (plan) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var ajs, dest;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    dest = _b.sent();
                    jest.spyOn(dest.integration, 'track');
                    return [4 /*yield*/, dest.track(new context_1.Context({ type: 'page', event: 'Track Event' }))];
                case 2:
                    _b.sent();
                    expect((_a = dest.integration) === null || _a === void 0 ? void 0 : _a.track).toHaveBeenCalled();
                    return [2 /*return*/];
    ...
    it('drops event when event is disabled', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dest, ctx;
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    dest = _b.sent();
                    jest.spyOn(dest.integration, 'track');
                    ctx = new context_1.Context({ type: 'page', event: 'Track Event' });
    ...
    it('drops event when unplanned event is disabled', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dest, ctx;
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
    ...
    it('does not drop enabled event for non-matching destination', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dest;
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
    ...
    it('doesnt set event integrations object with different event', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    dest = _a.sent();
                    return [4 /*yield*/, dest.track(new context_1.Context({ type: 'page', event: 'Not Track Event' }))];
                case 2:
                    ctx = _a.sent();
...
describe('option overrides', function () {
    ...
    it('accepts settings overrides from options', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, __1.ajsDestinations(cdnSettings, {}, initOptions)];
                case 1:
                    destinations = _b.sent();
                    amplitude = destinations[0];
                    return [4 /*yield*/, amplitude.load(context_1.Context.system(), {})];
                case 2:
                    _b.sent();
