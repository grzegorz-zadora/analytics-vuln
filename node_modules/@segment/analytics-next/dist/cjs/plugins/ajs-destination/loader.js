...
function loadIntegration(ctx, analyticsInstance, name, version, settings, obfuscate) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var pathName, obfuscatedPathName, fullPath, err_1, deps, integrationBuilder, analyticsStub, integration;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pathName = normalizeName(name);
                    obfuscatedPathName = obfuscatePathName(pathName, obfuscate);
                    fullPath = path + "/integrations/" + (obfuscatedPathName !== null && obfuscatedPathName !== void 0 ? obfuscatedPathName : pathName) + "/" + version + "/" + (obfuscatedPathName !== null && obfuscatedPathName !== void 0 ? obfuscatedPathName : pathName) + ".dynamic.js.gz";
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
...
function unloadIntegration(name, version, obfuscate) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var pathName, obfuscatedPathName, fullPath;
        return tslib_1.__generator(this, function (_a) {
            pathName = normalizeName(name);
            obfuscatedPathName = obfuscatePathName(name, obfuscate);
            fullPath = path + "/integrations/" + (obfuscatedPathName !== null && obfuscatedPathName !== void 0 ? obfuscatedPathName : pathName) + "/" + version + "/" + (obfuscatedPathName !== null && obfuscatedPathName !== void 0 ? obfuscatedPathName : pathName) + ".dynamic.js.gz";
            return [2 /*return*/, load_script_1.unloadScript(fullPath)];
        });
    });
}
