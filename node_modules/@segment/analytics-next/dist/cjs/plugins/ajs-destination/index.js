...
var LegacyDestination = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, loader_1.loadIntegration(ctx, analyticsInstance, this.name, this.version, this.settings, this.options.obfuscate)];
                    case 1:
    ...
    LegacyDestination.prototype.unload = function (_ctx, _analyticsInstance) {
        return loader_1.unloadIntegration(this.name, this.version, this.options.obfuscate);
    };
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        if (plan && ev && this.name !== 'Segment.io') {
                            planEvent = plan[ev];
                            if (!is_plan_event_enabled_1.isPlanEventEnabled(plan, planEvent)) {
