...
describe('Batching', function () {
    ...
    it('does not send requests right away', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dispatch;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dispatch = batched_dispatcher_1.default("https://api.segment.io").dispatch;
                    return [4 /*yield*/, dispatch("https://api.segment.io/v1/t", {
                            hello: 'world',
                        })];
                case 1:
                    _a.sent();
    ...
    it('sends requests after a batch limit is hit', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dispatch;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dispatch = batched_dispatcher_1.default("https://api.segment.io", {
                        size: 3,
                    }).dispatch;
                    return [4 /*yield*/, dispatch("https://api.segment.io/v1/t", {
                            event: 'first',
    ...
    it('sends requests if the size of events exceeds tracking API limits', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dispatch, i, i;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('sends requests when the timeout expires', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dispatch;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    expect(fetch).not.toHaveBeenCalled();
                    return [4 /*yield*/, dispatch("https://api.segment.io/v1/i", {
                            event: 'second',
                        })];
                case 2:
                    _a.sent();
    ...
    it('clears the buffer between flushes', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var dispatch;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    describe('on unload', function () {
        it('flushes the batch', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var dispatch;
            return tslib_1.__generator(this, function (_a) {
                dispatch = batched_dispatcher_1.default("https://api.segment.io").dispatch;
        ...
        it('flushes in batches of no more than 64kb', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var dispatch, i;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
