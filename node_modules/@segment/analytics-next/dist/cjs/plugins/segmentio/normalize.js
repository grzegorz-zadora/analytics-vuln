...
exports.normalize = exports.utm = exports.ampId = exports.sCookie = exports.getVersionType = exports.setVersionType = void 0;
...
function sCookie(key, value) {
    return js_cookie_1.set(key, value, cookieOptions);
}
exports.sCookie = sCookie;
function ampId() {
    var ampId = js_cookie_1.get('_ga');
...
function utm(query) {
    ...
    return query.split('&').reduce(function (acc, str) {
        ...
        if (k.includes('utm_') && k.length > 4) {
            ...
            acc[utmParam] = gracefulDecodeURIComponent_1.gracefulDecodeURIComponent(v);
        }
        return acc;
    }, {});
}
...
function referrerId(query, ctx) {
    var stored = js_cookie_1.get('s:context.referrer');
    var ad = ads(query);
    ...
    js_cookie_1.set('s:context.referrer', JSON.stringify(ad), cookieOptions);
}
function normalize(analytics, json, settings, integrations) {
    ...
    if (!ctx.library) {
        ...
        if (type === 'web') {
            ctx.library = {
                name: 'analytics.js',
                version: "next-" + version_1.version,
            };
        }
        else {
            ctx.library = {
                name: 'analytics.js',
                version: "npm:next-" + version_1.version,
            };
        }
    }
