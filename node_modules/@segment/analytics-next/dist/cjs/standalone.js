...
normalize_1.setVersionType('web');
...
function onError(err) {
    ...
    new remote_metrics_1.RemoteMetrics().increment('analytics_js.invoke.error', [
        'type:initialization',
        "message:" + (err === null || err === void 0 ? void 0 : err.message),
        "name:" + (err === null || err === void 0 ? void 0 : err.name),
        "wk:" + embedded_write_key_1.embeddedWriteKey(),
    ]);
}
document.addEventListener('securitypolicyviolation', function (e) {
    csp_detection_1.onCSPError(e).catch(console.error);
});
/**
...
if (browser_polyfill_1.shouldPolyfill()) {
