        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    expect(spy).toHaveBeenCalled();
                    expect(spy.mock.calls[0]).toMatchInlineSnapshot("\n      Array [\n        \"https://api.segment.io/v1/m\",\n        Object {\n          \"body\": \"{\\\"series\\\":[{\\\"type\\\":\\\"Counter\\\",\\\"metric\\\":\\\"analytics_js.banana\\\",\\\"value\\\":1,\\\"tags\\\":{\\\"phone\\\":\\\"1\\\",\\\"library\\\":\\\"analytics.js\\\",\\\"library_version\\\":\\\"npm:next-" + version_1.version + "\\\"}}]}\",\n          \"headers\": Object {\n            \"Content-Type\": \"text/plain\",\n          },\n          \"method\": \"POST\",\n        },\n      ]\n    ");
                    return [2 /*return*/];
            }
        });
    }); });
