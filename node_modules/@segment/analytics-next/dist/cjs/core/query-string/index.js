...
function queryString(analytics, query) {
    ...
    var params = parsed.split('&').reduce(function (acc, str) {
        ...
        acc[k] = gracefulDecodeURIComponent_1.gracefulDecodeURIComponent(v);
        return acc;
    }, {});
    var calls = [];
    ...
    if (ajs_uid) {
        var uid = Array.isArray(params.ajs_uid)
            ? params.ajs_uid[0]
            : params.ajs_uid;
        var traits = pickPrefix_1.pickPrefix('ajs_trait_', params);
    ...
    if (ajs_event) {
        var event_1 = Array.isArray(params.ajs_event)
            ? params.ajs_event[0]
            : params.ajs_event;
        var props = pickPrefix_1.pickPrefix('ajs_prop_', params);
